...
In the research world of visual decision-making, it's been known that people are biased by what their previous choices when they make decisions. Simple behavioral experiments demonstrated this. These experiments, often long and boring 💤 in which people sit in front of a computer screen and repeatedly make binary choices based on the visual stimulus. For example, a visual simulus can be a cloud of dots either dominantly moving towards the right or left. Every time when the stimulus appear, people have to make a speeded response on whether it's moving rightward or leftward.
...
But these studies have traditionally focused on one person only. By doing this, you are essentially assuming that humans are isolated "heads" out and about experiencing the world. In other words, the physical world we experience everyday does not only consists one instance of, let's say, distinguishing car key from a pile of keys. Rather it's more sophisticated than that. While searching for your car key you might have remembered discussing with your partner where it is located. **In fact, what we experience everyday is not only processing these surrouding sensory stimuli but also interactions with other people.**
